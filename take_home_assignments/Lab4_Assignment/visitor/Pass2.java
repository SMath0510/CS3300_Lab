...
public class Pass2<R,A> implements GJVisitor<R,A> {
   ...
   Boolean v0_use = false;
   Boolean v1_use = false;
   ...
   public R visit(HLoadStmt n, A argu) {
      ...
      String var_register = "v0";
      print("\tHLOAD " + var_register + " " + alloc_register2 + " " + offset);
      helper(var_name, var_register);
      return _ret;
   }
