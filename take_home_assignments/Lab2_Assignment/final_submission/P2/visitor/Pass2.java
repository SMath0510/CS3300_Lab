...
public class Pass2<R,A> implements GJVisitor<R,A> {
   ...
   public boolean cycleCheckHelper(String cname){
      ...
      while(!pname.equals("-1")){
         ...
         aList.add(pname);
         if(!classTable.containsKey(pname)){
            if(typecheck == 1){
               System.out.println("Error - CycleCheckerHelper");
            }
            symbolError();
         }
   ...
   public boolean isSameMethod(Pass1.methAttr methbase, Pass1.methAttr methderv){
      ...
      for(int i=0; i < argListBase.size() ;i++){
         ...
         boolean argtypecheck = typebase.equals(typederv);
         if(!argtypecheck)
         {
            if(typecheck == 1){
   ...
   public void checkDependenciesHelper(Pass1.methAttr mattr){
      Map<String, varAttr> varMap = mattr.varMap;
      Map<String, varAttr> argMap = mattr.arg.argMap;
      for (Map.Entry<String, Pass1.varAttr> entry : varMap.entrySet()) {
         String vname = entry.getKey();
         if(argMap.containsKey(vname)){
            if(typecheck == 1){
               System.out.println("Error - checkDependenciesHelper");
            }
            typeError();
         }
      }
   ...
   public R visit(ClassExtendsDeclaration n, A argu) {
      ...
      is_variable = 0;
      String cname = (String) n.f1.accept(this, argu);
      if(cname.equals("main") || cname.equals("Main")){
   ...
   public R visit(Identifier n, A argu) {
      ...
      // System.out.println("Apple " + idtype);
      // if(idtype != null){
      //    // it has a type
      //    System.out.println("Apple " + idtype + " " + idname);
      ...
      //          storedID = methVarMap.get(idname).type;
      //       }
      //       else if(methArgMap.containsKey(idname)){
      //          storedID = methArgMap.get(idname).type;
      //       }
      //       else if(classVarMap.containsKey(idname)){
      //          storedID = classVarMap.get(idname).type;
      //       }
      //       else{
      //          typeError();
      //       }
      ...
      //       }
      //    }
      //    if(!storedID.equals(idtype)){
      //       typeError();
      //    }
      // }
      // else{
      //    if(debug == 1){ 
      //       System.out.println("Without type? " + idname);
      //    }
      // }
      // if(debug == 1){
      //    System.out.println("Identifier returns = " + storedID);
      // }
      if(debug == 1) {
