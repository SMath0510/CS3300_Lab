...
public class Pass1<R, A> implements GJVisitor<R, A> {
   ...
   public static class varAttr {
      ...
      varAttr(String name, String type, String cname, String mname, Integer offset) {
         this.name = name;
         this.type = type;
         this.cname = cname;
         this.mname = mname;
      ...
      public varAttr copy() {
         return new varAttr(name, type, cname, mname, offset);
      }
   }
   ...
   public void constructTable() {
      for (Map.Entry<String, classAttr> entry : classTable1.entrySet()) {
         ...
         for(methAttr mattr : cattr.methList){
            mattr.offset = idx * 4;
            mattr.code = mattr.cname + "_DhruvOP_" + mattr.name;
            idx ++;
         }
         idx = 1;
         for(varAttr vattr : cattr.varList){
